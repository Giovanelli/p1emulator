...
function init() {
  window.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('#btn-military').addEventListener('click', () => {
      api.openMilitaryWindow();
    });

    document.querySelector('#btn-classroom').addEventListener('click', () => {
      api.openClassroomWindow();
    });

    document.querySelector('#btn-activity').addEventListener('click', () => {
      api.openActivityWindow();
    });
